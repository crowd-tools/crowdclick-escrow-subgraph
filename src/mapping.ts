...
export function handleCampaignCreated(event: CampaignCreated): void {
  ...
  //
  // - contract.collectedFee(...)
  // - contract.divider(...)
  // - contract.feeCollector(...)
  // - contract.feePercentage(...)
  // - contract.lastUserWithdrawalTime(...)
  // - contract.maximumWeiUserWithdrawal(...)
  // - contract.minimumUsdWithdrawal(...)
  // - contract.multiplier(...)
  // - contract.owner(...)
  // - contract.balanceOfPublisher(...)
  // - contract.balanceOfUser(...)
  // - contract.isUserWithdrawalEnabled(...)
  // - contract.lookupTask(...)
  // - contract.calculateWithdrawalRate(...)
}
